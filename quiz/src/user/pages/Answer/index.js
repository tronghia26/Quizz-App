          ...
          {dataAnswer.map((item) => (
            <div className="topic__list--item" key={item.id}>
              ...
              <div className="topic__list--content">
                ...
                <div className="topic__list--id">Mã bài làm: {item.id}</div>
                <Link className="topic__list--do" to={"/result/" + item.id}>
                  Xem chi tiểt
                </Link>
              </div>
              <div className="topic__list--para" key={item.id}>
                ...
                <div className="topic__list--time">
                  ...
                  <span>
                    {countQuestionByTopicId[item.topicId]
                      ? countQuestionByTopicId[item.topicId] + "p"
                      : "0p"}
                  </span>
                </div>
              </div>
